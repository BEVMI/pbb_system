                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="table-responsive">
                                <table class="table text-center" id="table" style="font-size: 12px;">
                                    <thead class="irene_thead" style="background-color: gray;">
                                        <tr>
                                            <td style="width: 70%;">CHECK RFA</td>
                                    ...
                                    <tbody class="text-center font-weight-bold">
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary w-100" onclick="checkRFA(0)">CHECK</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                ...
                                <table class="table text-center" id="table" style="font-size: 12px;">
                                    ...
                                    <tbody class="text-center font-weight-bold">
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input id="coa_check_update" class="form-control" type="text">
                                                </div>
                                            </td>
                                            <td>
                                                <button class="btn btn-primary w-100" onclick="checkRFA(1)">CHECK</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <div id="coa_update"></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<div class="modal fade" data-bs-backdrop='static' id="modalPrint" aria-hidden="false" role="dialog" aria-labelledby="modalPrintCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success"  onclick="irene()">
                    PRINT
                 </button>
