<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0">
        ...
        <span class="ms-1 font-weight-bold">PBB PMS SYSTEM</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        @endif
          ...
          @if($user_auth->is_warehouse=='1')
            <li class="nav-item">
              <a class="nav-link " href="{{route('loadsheet.index')}}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="fa-solid fa-sheet-plastic text-sm opacity-10"  style="color:rgb(145, 2, 247);"></i>
                </div>
                <span class="nav-link-text ms-1" style="margin-top:8px;">LOAD SHEET</span>
              </a>
            </li>
          @endif
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('tos.index')}}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book text-sm opacity-10"  style="color:rgb(2, 247, 59);"></i>
            </div>
            <span class="nav-link-text ms-1" style="margin-top:8px;">TOS</span>
          </a>
        </li>
