                        ...
                        <table class="table" style="border-left:1px solid black; border-right:1px solid black;">
                            ...
                            <tbody id="tbody_create" class="text-center" style="display:none; font-size:12px;">
                                ...
                                <tr>
                                    ...
                                    <td id="shift_length_create2" style="border-right:1px solid black ;">
                                        0
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td id="expected_oprl_create" style="border-right:1px solid black ;">0</td>
                                    <td >Availability(%)</td>
                                    <td id="availability_create">81.25%</td>
                                </tr>

                                <tr>
                                    <td>Unexpected Oprl Downtime, mins</td>
                                    <td id="unexpected_oprl_create" style="border-right:1px solid black ;">0</td>
                                    <td>Performance(%)</td>
                                    <td id="performance_create">52.75%</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td id="machine_downtime_create" style="border-right:1px solid black ;">0</td>
                                    <td>-</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td id="downtime_variance_create" style="border-right:1px solid black ;">0</td>
                                    <td>-</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td style="border-bottom:1px solid black ;">Running Time</td>
                                    <td id="running_time_create" style="border-right:1px solid black ; border-bottom:1px solid black ;">0</td>
